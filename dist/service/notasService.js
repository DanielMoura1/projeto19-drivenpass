...
export function criarnotaNome(nota, id) {
    return __awaiter(this, void 0, void 0, function () {
        var sites;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function pegarnota(id, cd) {
    return __awaiter(this, void 0, void 0, function () {
        var site, n;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('site');
                    return [4 /*yield*/, userRepository.getnota(id, cd)];
                case 1:
                    site = _a.sent();
                    console.log(site);
                    console.log('teste');
...
export function criarNota(credenciais, id) {
    return __awaiter(this, void 0, void 0, function () {
        var cd;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function pegarnotas(id, idUsuario) {
    return __awaiter(this, void 0, void 0, function () {
        var usuario;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userRepository.getNotas(id, idUsuario)];
                case 1:
                    usuario = _a.sent();
                    if (usuario.length === 0) {
